...
def parse():
    ...
    parser.add_argument('--data', metavar='DIR', default='/home/zzhehao/CharadesEgo/CharadesEgo_v1_rgb/', help='path to dataset')
    parser.add_argument('--dataset', default='fake', help='name of dataset under datasets/')
    parser.add_argument('--egocentric-test-data', default='/home/zzhehao/CharadesEgo/CharadesEgo/CharadesEgo_v1_test_only1st.csv', help='path to labels for egocentric classification')
    parser.add_argument('--original-charades-train', default='/home/zzhehao/CharadesEgo/CharadesEgo/CharadesEgo_v1_train.csv', help='Original Charades Train')
    parser.add_argument('--original-charades-test', default='/home/zzhehao/CharadesEgo/CharadesEgo/CharadesEgo_v1_test.csv', help='Original Charades Test')
    parser.add_argument('--original-charades-data', default='/home/zzhehao/CharadesEgo/CharadesEgo_v1_rgb/', help='path to original charades frames')
    parser.add_argument('--train-file', default='/home/zzhehao/CharadesEgo/CharadesEgo/CharadesEgo_v1_train.csv', type=str)
    parser.add_argument('--val-file', default='/home/zzhehao/CharadesEgo/CharadesEgo/CharadesEgo_v1_test.csv', type=str)
    ...
    parser.add_argument('--subloss2', default='AttentionDist')
